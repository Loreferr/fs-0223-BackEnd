...
public class Runner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Edificio E1 = es.createCustomEdificio("Mazzini", "Via Giuseppe Mazzini 12", "Roma");
		Edificio E2 = es.createCustomEdificio("Verdi", "Via Verdi 23", "Pavia");
		Edificio E3 = es.createCustomEdificio("Armaldo", "Via Adinolfi 23", "Cava de'Tirreni");
		// es.saveEdificio(E3);
		// es.removeEdificio(E1);
		// es.updateEdificio(E1);
		es.findEdificioByName("Mazzini");

		Postazione P1 = pos.createCustomPostazione(1, " Accesso Internet, Double Monitor ", Tipo.Privato, 1, E1);
		Postazione P2 = pos.createCustomPostazione(2, " Full Option", Tipo.OpenSpace, 10, E2);
		Postazione P3 = pos.createCustomPostazione(3, " Gaming House", Tipo.SalaRiunioni, 15, E3);
		...
		// LocalDate.of(2023, 9, 21));
		Prenotazione PR3 = ps.createCustomPrenotazione(3, Utente3, P3, LocalDate.of(2023, 10, 21));
